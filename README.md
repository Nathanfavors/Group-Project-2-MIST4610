...
## Data Description
Our dataset encompasses a variety of metrics detailing car accidents occurring in Tempe, Arizona, where Arizona State University is situated. The dataset contains tables linked to metrics that might have influenced a collision, including factors like alcohol/drug use, road surface condition, light condition, and weather. Additional tables uniquely pinpoint each accident and incident identification by utilizing information such as the date/time, manner of collision, age and gender of each driver, street names/ junctions, and severity of injuries. Several tables within our dataset are divided based on attributes for each involved driver. However, we designate "Driver 1" as being at fault due to the organization of the violations report. Given that our data focuses on a particular college town, the age distribution of drivers typically mirrors the high concentration of college students, with fewer accidents occurring overall during the summer months. Additionally, since the majority of our tables consist of categorical data, our visualizations will often count the distinct or repeated instances of an event to generate quantitative data suitable for graphing.
...
## Question 2: How does the occurrence of different manners of collisions vary based on driver age in Tempe?
